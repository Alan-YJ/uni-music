<template>
	<view class="content">
		<swiper class='banner-wrap' indicator-dots="true" autoplay="true" circular='true' duration="300" indicator-active-color="#ff2419" :style="{height:swiperHeight+'px'}">
			<swiper-item v-for='swiper in bannerList' :item-id="swiper.index">
				<navigator :url='swiper.url'>
					<image class='image' :src="swiper.pic.replace('http:','https:')" mode="widthFix"></image>
...
<script>
	import { getHomeBanners, getRecommendPlayList } from '@/apis/homepage/index.js'
	import { traceCount } from '@/untils/index'
